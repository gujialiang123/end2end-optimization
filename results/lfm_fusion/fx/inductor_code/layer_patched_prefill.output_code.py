...
#   %mul : Tensor "bf16[512, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_3, %getitem_5), kwargs = {})
#   %permute_1 : Tensor "bf16[2048, 512][1, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%mul, [1, 0]), kwargs = {})
#   %clone : Tensor "bf16[2048, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.clone.default](args = (%permute_1,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone
...
#   %split : [num_users=3] = call_function[target=torch.ops.aten.split.Tensor](args = (%mm, 2048, -1), kwargs = {})
#   %permute_3 : Tensor "bf16[512, 2048][1, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%clone, [1, 0]), kwargs = {})
#   %mul_1 : Tensor "bf16[512, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_4, %permute_3), kwargs = {})
#   return %mul_1
...
#   %arg11_1 : Tensor "f32[32][1]cuda:0" = PlaceHolder[target=arg11_1]
...
#   %add : Tensor "f32[512, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sigmoid, %arg11_1), kwargs = {})
#   return %add
...
#   getitem_9 => select
# Graph fragment:
#   %getitem_14 : Tensor "i64[512, 4][4, 1]cuda:0" = PlaceHolder[target=getitem_14]
#   %arg12_1 : Tensor "bf16[32, 3584, 2048][7340032, 2048, 1]cuda:0" = PlaceHolder[target=arg12_1]
#   %select : Tensor "i64[4][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%getitem_14, 0, 0), kwargs = {})
#   %index : Tensor "bf16[4, 3584, 2048][7340032, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg12_1, [%select]), kwargs = {})
#   return %index
...
#   act => mul_3
#   chunk_1 => split_1
#   gate_up => permute_12, unsqueeze_default, view_3, view_4
...
#   %permute_12 : Tensor "bf16[512, 4, 3584, 1][14336, 3584, 1, 14336]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_3, [0, 2, 3, 1]), kwargs = {})
#   %view_4 : Tensor "bf16[512, 4, 3584][14336, 3584, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_12, [512, 4, 3584]), kwargs = {})
#   %split_1 : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%view_4, 1792, -1), kwargs = {})
#   %convert_element_type_10 : Tensor "f32[512, 4, 1792][7168, 1792, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_15, torch.float32), kwargs = {})
...
#   %mul_3 : Tensor "bf16[512, 4, 1792][7168, 1792, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_11, %getitem_16), kwargs = {})
#   return %mul_3
...
# Graph fragment:
#   %getitem_14 : Tensor "i64[512, 4][4, 1]cuda:0" = PlaceHolder[target=getitem_14]
#   %arg13_1 : Tensor "bf16[32, 2048, 1792][3670016, 1792, 1]cuda:0" = PlaceHolder[target=arg13_1]
#   %select_1 : Tensor "i64[4][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%getitem_14, 0, 0), kwargs = {})
#   %index_1 : Tensor "bf16[4, 2048, 1792][3670016, 1792, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg13_1, [%select_1]), kwargs = {})
#   return %index_1
...
#   %convert_element_type_6 : Tensor "f32[512, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
#   %sigmoid : Tensor "f32[512, 32][32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%convert_element_type_6,), kwargs = {})
#   %gather : Tensor "f32[512, 4][4, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.gather.default](args = (%sigmoid, 1, %getitem_14), kwargs = {})
...
# kernel path: /home/t-jialianggu/work/EndtoEnd-auto-optimization/results/lfm_fusion/fx/inductor_cache/5q/c5qlhjo3qxuderd3xdcphisfaeyieclgwerpd3hmc25looaygswe.py
# Topologically Sorted Source Nodes: [float_1, scores, per_expert, topk_w, sum_1, topk_w_1, topk_w_2, unsqueeze, mul_3, out], Original ATen: [aten._to_copy, aten.sigmoid, aten.view, aten.permute, aten.gather, aten.sum, aten.div, aten.unsqueeze, aten.mul]
# Source node to ATen node mapping:
#   float_1 => convert_element_type_6
#   mul_3 => mul_4
#   out => sum_2
#   per_expert => permute_17, view_7, view_8
#   scores => sigmoid
#   sum_1 => sum_1
#   topk_w => gather
#   topk_w_1 => div
...
#   %permute_17 : Tensor "bf16[512, 4, 2048, 1][2048, 1048576, 1, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_7, [1, 0, 3, 2]), kwargs = {})
#   %view_8 : Tensor "bf16[512, 4, 2048][2048, 1048576, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_17, [512, 4, 2048]), kwargs = {})
#   %gather : Tensor "f32[512, 4][4, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.gather.default](args = (%sigmoid, 1, %getitem_14), kwargs = {})
#   %sum_1 : Tensor "f32[512, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%gather, [-1], True), kwargs = {})
...
#   return %sum_2
triton_poi_fused__to_copy_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_7 = async_compile.triton('triton_poi_fused__to_copy_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_7', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_7', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 9, 'num_reduction': 0, 'backend_hash': 'E32C50C3B9CF9CDC47D62CC6811346E52908133A0176777B4DADF595E1971975', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_7(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 1048576
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg10_1, (32, 2048), (2048, 1))
        assert_size_stride(arg11_1, (32, ), (1, ))
        assert_size_stride(arg12_1, (32, 3584, 2048), (7340032, 2048, 1))
        assert_size_stride(arg13_1, (32, 2048, 1792), (3670016, 1792, 1))
        with torch.cuda._DeviceGuard(0):
            ...
            del arg1_1
            del arg3_1
            buf4 = empty_strided_cuda((2048, 512), (512, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [chunk, Bx, transpose, Bx_t], Original ATen: [aten.split, aten.mul, aten.transpose, aten.clone]
            ...
            torch.ops.sgl_kernel.causal_conv1d_fwd.default(buf4, arg4_1, None, arg5_1, arg6_1, arg7_1, None, False, -1)
            del arg4_1
            del arg5_1
            del arg6_1
            del arg7_1
            ...
            # Topologically Sorted Source Nodes: [chunk, mul_1, hidden_states], Original ATen: [aten.split, aten.transpose, aten.mul, aten.t, aten.mm]
            extern_kernels.mm(buf9, reinterpret_tensor(arg8_1, (2048, 2048), (1, 2048), 0), out=buf10)
            del arg8_1
            del buf9
            # Topologically Sorted Source Nodes: [fused_add_rmsnorm_default_1], Original ATen: [sgl_kernel.fused_add_rmsnorm]
            torch.ops.sgl_kernel.fused_add_rmsnorm.default(buf10, arg0_1, arg9_1, 1e-05, True)
            del arg0_1
            del arg9_1
            ...
            extern_kernels.mm(buf10, reinterpret_tensor(arg10_1, (2048, 32), (1, 2048), 0), out=buf14)
            del arg10_1
            buf15 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
            # Topologically Sorted Source Nodes: [float_1, scores, scores_for_choice], Original ATen: [aten._to_copy, aten.sigmoid, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_sigmoid_2.run(buf14, arg11_1, buf15, 16384, stream=stream0)
            del arg11_1
            ...
            # Topologically Sorted Source Nodes: [getitem_9, getitem_10], Original ATen: [aten.select, aten.index]
            stream0 = get_raw_stream(0)
            triton_poi_fused_index_select_3.run(buf18, arg12_1, buf19, 29360128, stream=stream0)
            del arg12_1
            ...
            extern_kernels.mm(buf10, reinterpret_tensor(buf19, (2048, 14336), (1, 2048), 0), out=buf20)
            del buf19
            ...
            # Topologically Sorted Source Nodes: [getitem_13, getitem_14], Original ATen: [aten.select, aten.index]
            stream0 = get_raw_stream(0)
            triton_poi_fused_index_select_5.run(buf18, arg13_1, buf22, 14680064, stream=stream0)
            del arg13_1
            ...
            # Topologically Sorted Source Nodes: [float_1, scores, per_expert, topk_w, sum_1, topk_w_1, topk_w_2, unsqueeze, mul_3, out], Original ATen: [aten._to_copy, aten.sigmoid, aten.view, aten.permute, aten.gather, aten.sum, aten.div, aten.unsqueeze, aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_7.run(buf23, buf18, buf14, buf24, buf25, 1048576, stream=stream0)
            del buf14
            del buf18
            del buf23
            del buf24
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((512, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    arg6_1 = rand_strided((2, ), (1, ), device='cuda:0', dtype=torch.int32)
    ...
    arg10_1 = rand_strided((32, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    arg11_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg12_1 = rand_strided((32, 3584, 2048), (7340032, 2048, 1), device='cuda:0', dtype=torch.bfloat16)
    arg13_1 = rand_strided((32, 2048, 1792), (3670016, 1792, 1), device='cuda:0', dtype=torch.bfloat16)
