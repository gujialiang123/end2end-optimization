...
#   %mul : Tensor "bf16[8, 2048][2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_2, %getitem_4), kwargs = {})
#   return %mul
...
# Graph fragment:
#   %arg4_1 : Tensor "i64[8][1]cuda:0" = PlaceHolder[target=arg4_1]
#   %convert_element_type_2 : Tensor "i32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg4_1, torch.int32), kwargs = {})
...
#   %causal_conv1d_update_default : [num_users=0] = call_function[target=torch.ops.sgl_kernel.causal_conv1d_update.default](args = (%as_strided_default, %arg5_1, %arg3_1, None, False, None, %convert_element_type_2, -1), kwargs = {})
#   return %buf5
...
#   %mul_1 : Tensor "bf16[8, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_3, %squeeze_1), kwargs = {})
#   return %mul_1
...
#   %arg9_1 : Tensor "f32[32][1]cuda:0" = PlaceHolder[target=arg9_1]
...
#   %add_1 : Tensor "f32[8, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sigmoid, %arg9_1), kwargs = {})
#   return %add_1
...
#   getitem_9 => select
# Graph fragment:
#   %getitem_12 : Tensor "i64[8, 4][4, 1]cuda:0" = PlaceHolder[target=getitem_12]
#   %arg10_1 : Tensor "bf16[32, 3584, 2048][7340032, 2048, 1]cuda:0" = PlaceHolder[target=arg10_1]
#   %select : Tensor "i64[4][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%getitem_12, 0, 0), kwargs = {})
#   %index : Tensor "bf16[4, 3584, 2048][7340032, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg10_1, [%select]), kwargs = {})
#   return %index
...
#   act => mul_3
#   chunk_1 => split_1
#   gate_up => permute_11, unsqueeze_default, view_3, view_4
...
#   %permute_11 : Tensor "bf16[8, 4, 3584, 1][14336, 3584, 1, 14336]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_3, [0, 2, 3, 1]), kwargs = {})
#   %view_4 : Tensor "bf16[8, 4, 3584][14336, 3584, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_11, [8, 4, 3584]), kwargs = {})
#   %split_1 : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%view_4, 1792, -1), kwargs = {})
#   %convert_element_type_11 : Tensor "f32[8, 4, 1792][7168, 1792, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%getitem_13, torch.float32), kwargs = {})
...
#   %mul_3 : Tensor "bf16[8, 4, 1792][7168, 1792, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_12, %getitem_14), kwargs = {})
#   return %mul_3
...
# Graph fragment:
#   %getitem_12 : Tensor "i64[8, 4][4, 1]cuda:0" = PlaceHolder[target=getitem_12]
#   %arg11_1 : Tensor "bf16[32, 2048, 1792][3670016, 1792, 1]cuda:0" = PlaceHolder[target=arg11_1]
#   %select_1 : Tensor "i64[4][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%getitem_12, 0, 0), kwargs = {})
#   %index_1 : Tensor "bf16[4, 2048, 1792][3670016, 1792, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg11_1, [%select_1]), kwargs = {})
#   return %index_1
...
#   %convert_element_type_7 : Tensor "f32[8, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
#   %sigmoid : Tensor "f32[8, 32][32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%convert_element_type_7,), kwargs = {})
#   %gather : Tensor "f32[8, 4][4, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.gather.default](args = (%sigmoid, 1, %getitem_12), kwargs = {})
...
# kernel path: /home/t-jialianggu/work/EndtoEnd-auto-optimization/results/lfm_fusion/fx/inductor_cache/f2/cf2eiihkyaxz4xusfytqvxh5apgdexcngbqxhbgstuo7cwuwkaex.py
# Topologically Sorted Source Nodes: [float_1, scores, per_expert, topk_w, sum_1, topk_w_1, topk_w_2, unsqueeze_1, mul_3, out_2, out_3, hidden_states_2], Original ATen: [aten._to_copy, aten.sigmoid, aten.view, aten.permute, aten.gather, aten.sum, aten.div, aten.unsqueeze, aten.mul, aten.add]
# Source node to ATen node mapping:
#   float_1 => convert_element_type_7
...
#   out_2 => sum_2
#   out_3 => mul_5
#   per_expert => permute_16, view_7, view_8
#   scores => sigmoid
#   sum_1 => sum_1
#   topk_w => gather
#   topk_w_1 => div
...
#   %addmm_default : Tensor "bf16[8, 2048][2048, 1]cuda:0" = PlaceHolder[target=addmm_default]
#   %sum_2 : Tensor "bf16[8, 2048][2048, 1]cuda:0" = PlaceHolder[target=sum_2]
#   %convert_element_type_7 : Tensor "f32[8, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
#   %sigmoid : Tensor "f32[8, 32][32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%convert_element_type_7,), kwargs = {})
...
#   %permute_16 : Tensor "bf16[8, 4, 2048, 1][2048, 16384, 1, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_7, [1, 0, 3, 2]), kwargs = {})
#   %view_8 : Tensor "bf16[8, 4, 2048][2048, 16384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_16, [8, 4, 2048]), kwargs = {})
#   %gather : Tensor "f32[8, 4][4, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.gather.default](args = (%sigmoid, 1, %getitem_12), kwargs = {})
#   %sum_1 : Tensor "f32[8, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%gather, [-1], True), kwargs = {})
...
#   %mul_5 : Tensor "bf16[8, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_2, 1.0), kwargs = {})
#   %add_2 : Tensor "bf16[8, 2048][2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%addmm_default, %mul_5), kwargs = {})
#   return %sum_2,%add_2
triton_poi_fused__to_copy_add_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_8 = async_compile.triton('triton_poi_fused__to_copy_add_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_8', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_add_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_8', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 10, 'num_reduction': 0, 'backend_hash': 'E32C50C3B9CF9CDC47D62CC6811346E52908133A0176777B4DADF595E1971975', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused__to_copy_add_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_8(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, XBLOCK : tl.constexpr):
    xnumel = 16384
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg5_1, (64, 2048, 3), (6144, 3, 1))
        assert_size_stride(arg6_1, (2048, 2048), (2048, 1))
        assert_size_stride(arg7_1, (2048, ), (1, ))
        assert_size_stride(arg8_1, (32, 2048), (2048, 1))
        assert_size_stride(arg9_1, (32, ), (1, ))
        assert_size_stride(arg10_1, (32, 3584, 2048), (7340032, 2048, 1))
        assert_size_stride(arg11_1, (32, 2048, 1792), (3670016, 1792, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf0 = empty_strided_cuda((8, 2048), (2048, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [to, causal_conv1d_update], Original ATen: [aten._to_copy, aten.as_strided, sgl_kernel.causal_conv1d_update]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_as_strided_causal_conv1d_update_1.run(arg4_1, buf5, 8, stream=stream0)
            del arg4_1
            # Topologically Sorted Source Nodes: [to, causal_conv1d_update], Original ATen: [aten._to_copy, aten.as_strided, sgl_kernel.causal_conv1d_update]
            torch.ops.sgl_kernel.causal_conv1d_update.default(reinterpret_tensor(buf4, (8, 2048, 1), (2048, 1, 1), 0), arg5_1, arg3_1, None, False, None, buf5, -1)
            del arg3_1
            del arg5_1
            del buf5
            ...
            # Topologically Sorted Source Nodes: [chunk, mul_1, hidden_states], Original ATen: [aten.split, aten.unsqueeze, aten.squeeze, aten.mul, aten.t, aten.addmm]
            extern_kernels.addmm(arg0_1, buf10, reinterpret_tensor(arg6_1, (2048, 2048), (1, 2048), 0), alpha=1, beta=1, out=buf11)
            del arg0_1
            del arg6_1
            buf12 = buf10; del buf10  # reuse
            # Topologically Sorted Source Nodes: [out_1, rmsnorm_default_1], Original ATen: [aten.empty_like, sgl_kernel.rmsnorm]
            torch.ops.sgl_kernel.rmsnorm.default(buf12, buf11, arg7_1, 1e-05, True)
            del arg7_1
            ...
            extern_kernels.mm(buf12, reinterpret_tensor(arg8_1, (2048, 32), (1, 2048), 0), out=buf15)
            del arg8_1
            buf16 = empty_strided_cuda((8, 32), (32, 1), torch.float32)
            # Topologically Sorted Source Nodes: [float_1, scores, scores_for_choice], Original ATen: [aten._to_copy, aten.sigmoid, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_sigmoid_3.run(buf15, arg9_1, buf16, 256, stream=stream0)
            del arg9_1
            ...
            # Topologically Sorted Source Nodes: [getitem_9, getitem_10], Original ATen: [aten.select, aten.index]
            stream0 = get_raw_stream(0)
            triton_poi_fused_index_select_4.run(buf19, arg10_1, buf20, 29360128, stream=stream0)
            del arg10_1
            ...
            extern_kernels.mm(buf12, reinterpret_tensor(buf20, (2048, 14336), (1, 2048), 0), out=buf21)
            del buf12
            del buf20
            ...
            # Topologically Sorted Source Nodes: [getitem_13, getitem_14], Original ATen: [aten.select, aten.index]
            stream0 = get_raw_stream(0)
            triton_poi_fused_index_select_6.run(buf19, arg11_1, buf23, 14680064, stream=stream0)
            del arg11_1
            ...
            # Topologically Sorted Source Nodes: [float_1, scores, per_expert, topk_w, sum_1, topk_w_1, topk_w_2, unsqueeze_1, mul_3, out_2, out_3, hidden_states_2], Original ATen: [aten._to_copy, aten.sigmoid, aten.view, aten.permute, aten.gather, aten.sum, aten.div, aten.unsqueeze, aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_div_gather_mul_permute_sigmoid_sum_unsqueeze_view_8.run(buf27, buf24, buf19, buf15, buf25, 16384, stream=stream0)
            del buf15
            del buf19
            del buf24
            del buf25
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg4_1 = rand_strided((8, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg5_1 = rand_strided((64, 2048, 3), (6144, 3, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    arg8_1 = rand_strided((32, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    arg9_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg10_1 = rand_strided((32, 3584, 2048), (7340032, 2048, 1), device='cuda:0', dtype=torch.bfloat16)
    arg11_1 = rand_strided((32, 2048, 1792), (3670016, 1792, 1), device='cuda:0', dtype=torch.bfloat16)
